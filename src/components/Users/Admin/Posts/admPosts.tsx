                ...
                <Table>
                    ...
                    <TableBody>
                        {posts.map((post,i) => (
                            <TableRow key={i}>
                                <TableCell>
                                    <Link to={`/admin/posts/edit/${post._id}`}>{post.name}</Link>
                                </TableCell>
                                <TableCell align="right">{post.author}</TableCell>
                                <TableCell align="right">{moment(post.createdAt).format("YYYY/MM/DD")}</TableCell>
                                <TableCell align="right">{post.rating}</TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
                </Table>
